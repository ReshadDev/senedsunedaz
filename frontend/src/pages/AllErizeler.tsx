...
const AllErizeler: React.FC = () => {
  ...
  const handleCategoryClick = async (category: string) => {
    try {
      ...
      if (category === selectedCategory) {
        // If the same category is clicked again, unselect it and show all products
  ...
  const filteredItems = erizeler.filter((erize) => {
    const searchTerms = searchTerm.split(" ").filter(Boolean); // Split and filter empty strings
